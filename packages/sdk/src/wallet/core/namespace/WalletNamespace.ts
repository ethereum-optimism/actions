...
> {
  private provider: WalletProvider<TEmbeddedProviderType, TToActionsMap, H, S>

  constructor(
    provider: WalletProvider<TEmbeddedProviderType, TToActionsMap, H, S>,
  ) {
  ...
  async toActionsWallet(
    ...
    return this.provider.embeddedWalletToActionsWallet(params)
  }
