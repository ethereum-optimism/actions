...
import type { TurnkeyEmbeddedWalletToActionsWalletOptions } from '@/wallet/react/providers/embedded/types/index.js'
...
export async function createSigner(
  params: TurnkeyEmbeddedWalletToActionsWalletOptions,
