...
/**
 * Minimal mock implementation matching the shape of EmbeddedWalletProvider<'privy'>
 * for use in unit tests without importing browser-only dependencies.
 */
export class PrivyEmbeddedWalletProviderMock extends EmbeddedWalletProvider<
  'privy',
  ReactToActionsOptionsMap
> {
