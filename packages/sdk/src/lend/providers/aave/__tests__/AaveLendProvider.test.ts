...
describe('AaveLendProvider', () => {
  ...
  describe('openPosition', () => {
    ...
    it('should create native ETH deposit without approval', async () => {
      ...
      expect(lendTransaction.amount).toBe(1)
      expect(lendTransaction.amountRaw).toBe(BigInt('1000000000000000000'))
  ...
  describe('closePosition', () => {
    ...
    it('should create native ETH withdrawal with approval', async () => {
      ...
      expect(withdrawTransaction.amount).toBe(1)
      expect(withdrawTransaction.amountRaw).toBe(BigInt('1000000000000000000'))
