...
interface EmbeddedWalletsSectionProps {
  stepNumber: number | string
  openAccordion: string | null
  setOpenAccordion: (value: string | null) => void
}

function EmbeddedWalletsSection({
  stepNumber,
  openAccordion,
  setOpenAccordion,
}: EmbeddedWalletsSectionProps) {
...
// ACTIONS: Let wallet make onchain Actions
const verbsDynamicWallet = await actions.wallet.embeddedWalletToVerbsWallet({
...
const wallet = await actions.wallet.toActionsWallet({
  ...
  return (
    <>
      {/* Accordion Item 3: BYO embedded wallets */}
      <div className="mb-4">
        <button
          onClick={() =>
            setOpenAccordion(
...
export default EmbeddedWalletsSection
