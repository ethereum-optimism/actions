    ...
    >
      <div className="flex items-center gap-2">
        ...
        {isFetching ? (
          ...
          <div className="flex items-center gap-1.5">
            {logo && (
              <img src={logo} alt={bestProvider} className="h-4 w-4" />
            )}
            <span
              className="text-xs font-medium"
              style={{ color: '#1a1b1e' }}
      ...
      <div className="relative" ref={tooltipRef}>
        ...
        {showTooltip && (
          ...
          >
            <p className="text-xs leading-relaxed" style={{ color: '#E0E2EB' }}>
              <strong style={{ color: '#FFFFFF' }}>Simulated for testnet.</strong>{' '}
