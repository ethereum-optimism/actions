...
describe('Lend Service', () => {
  ...
  describe('getVaults', () => {
    ...
    it('should handle unknown errors', async () => {
      mockLendProvider.markets.mockRejectedValue('Unknown error')
